<!DOCTYPE html>
  <html>
    <head>
      ...
      <title>SIAKAD STAK-RRI | Cetak Presensi</title>
    ...
    <div class="wrapper">
      <section class="invoice">
        <div class="row">
          ...
          <h4 class="text-center"><b>PRESENSI KELAS <?= $jadwal['nama_kelas'] ?> - <?= $jadwal['angkatan'] ?>/TA. <?= $ta['ta'] ?> (<?= $ta['semester'] ?>)</b></h4>
        </div>
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($value['p1'] == 0) {
                      ...
                      echo '<i class="fa fa-info text-yellow"></i>';
                    } elseif ($value['p1'] == 2) {
